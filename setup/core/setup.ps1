...
param (
	...
	[string]                 $imageCodeDxTomcatInit   = 'codedx/codedx-bash:v0.0.9',
	[string]                 $imageMariaDB            = 'codedx/codedx-mariadb:v0.0.9',
	[string]                 $imageMinio              = 'bitnami/minio:2020.3.25-debian-10-r4',
	[string]                 $imageWorkflowController = 'codedx/codedx-workflow-controller:v2.12.1',
	[string]                 $imageWorkflowExecutor   = 'codedx/codedx-argoexec:v2.12.1',
